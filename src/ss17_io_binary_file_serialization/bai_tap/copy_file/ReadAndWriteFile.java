...
public class ReadAndWriteFile {
    ...
    public static void main(String[] args) {
        final String FILE_PATH2 = "src/ss17_io_binary_file_serialization/bai_tap/copy_file/file_copy.dat";
        writeToFile(FILE_PATH2, readFromFile("ss17_io_binary_file_serialization/bai_tap/product/product.dat"));
    }
}
